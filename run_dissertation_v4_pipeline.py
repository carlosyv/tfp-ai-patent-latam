#!/usr/bin/env python3
"""
run_dissertation_v4_pipeline.py
================================
Complete TFP-AI pipeline — v4 (updated moderation hypotheses & expanded controls)
...
OUT_DIR = RESULTS_DIR / 'benchmark_dissertation_v4'
...
def main():
    ...
    solow_df.to_csv(RESULTS_DIR / 'solow_tfp_dissertation_v4.csv', index=False)
    ...
    mq.to_csv(RESULTS_DIR / 'malmquist_dissertation_v4.csv', index=False)
    ...
    merged.to_csv(RESULTS_DIR / 'merged_dissertation_v4.csv', index=False)
    ...
    print(f"\n  Key outputs:")
    print(f"    • merged_dissertation_v4.csv      (full panel dataset)")
